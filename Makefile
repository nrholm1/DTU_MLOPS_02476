...
PROJECT_NAME = "mlops_mnist_classifier"
PYTHON_VERSION = 3.11
...
eval: 
	$(PYTHON_INTERPRETER) $(PROJECT_NAME)/predict_model.py evaluate $(ckpt)

# Use trained model to make prediction
predict: 
	$(PYTHON_INTERPRETER) $(PROJECT_NAME)/predict_model.py predict $(ckpt) $(pred_path)

visualize: 
	$(PYTHON_INTERPRETER) $(PROJECT_NAME)/predict_model.py visualize $(ckpt)
